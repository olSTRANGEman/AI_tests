...
def create_and_verify_pet():
    ...
    for _ in range(5):
        ...
        time.sleep(0.6)
    pytest.fail(f"Failed to verify pet creation for ID {pet_data['id']}")
...
def create_and_verify_user():
    ...
    if post_response.status_code != 200: pytest.fail(f"Pre-test user creation failed")
    time.sleep(0.5)
    return user_data
