...
def test_post_pet_unsupported_media():
    ...
    # invalid input should return 405 per spec
...
def test_find_pets_by_status_missing_param():
    ...
    # missing status param should return 400 per spec
    assert resp.status_code == 400
...
def test_update_pet_with_form():
    ...
    # update with form returns method not allowed 405
    assert resp.status_code == 405
...
def test_find_pets_by_tags_missing_param():
    ...
    # missing tags param should return 400 per spec
    assert resp.status_code == 400
...
def test_place_order_missing_field():
    ...
    # missing fields returns 400 per spec
    assert resp.status_code == 400
